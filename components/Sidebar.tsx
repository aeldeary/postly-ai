...
import { HomeIcon, CreatePostIcon, WebsiteIcon, ImageIcon, StyleIcon, ArchiveIcon, InfoIcon, MagicWandIcon, LightBulbIcon, VideoCameraIcon, SpeakerWaveIcon, DocumentTextIcon, CogIcon, PaintBrushIcon, ChartBarIcon, TemplateIcon } from './Icons';
  ...
  return (
    ...
    <aside className={`fixed top-0 ${sidebarPositionClass} z-40 w-64 h-[100dvh] max-h-[100dvh] flex flex-col bg-[#0a1e3c]/60 backdrop-blur-xl border-white/10 transition-transform duration-300 ${translateClass}`}>
        <div className="flex flex-col items-center mt-8 mb-6 shrink-0">
            <h1 className="text-2xl font-bold text-[#bf8339] tracking-wide">Postly-AI</h1>
            <div className="h-1 w-12 bg-[#bf8339] rounded-full mt-2"></div>
        </div>
