...
export const Loader: React.FC = () => (
    <svg className="animate-spin h-8 w-8 text-[#bf8339]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
export const FingerPrintIcon: React.FC<{className?: string}> = ({className}) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || iconProps.className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.864 4.243A7.5 7.5 0 0119.5 10.5c0 2.92-.556 5.709-1.568 8.268M5.742 6.364A7.465 7.465 0 004.5 10.5a7.464 7.464 0 01-1.15 3.993m1.989 3.559A11.209 11.209 0 008.25 10.5a3.75 3.75 0 117.5 0c0 .527-.021 1.049-.064 1.565m-9.519 2.282A5.96 5.96 0 016 12a6 6 0 00-6 6v3a6 6 0 006 6h2a6 6 0 006-6v-3a6 6 0 00-6-6 5.96 5.96 0 00-2.25.432M12 21a9.004 9.004 0 01-2.517-5.32" />
  </svg>
);
